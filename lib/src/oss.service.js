...
let OSS = class OSS {
    ...
    putStream(target, imageStream) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.ossClient.putStream(target, imageStream);
        });
    }
    getStream(target) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.ossClient.getStream(target);
        });
    }
    delete(target) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.ossClient.delete(target);
        });
    }
    deleteMulti(targets) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.ossClient.deleteMulti(targets);
        });
    }
    getImgName(filename) {
